...
ROI = [24 108 24 73 5 5];     % subdomain of the PIV field
...
SaveName = sprintf('ProbeTraversing_R%d_%dpr_NM_p2D.mat', ResSensors,NSensors);
tic
...
FieldStd = std([U_train-Um;V_train-Vm], 0, 'all');
toc
...
[~, sub_SigmaU, sub_PhiU] = svd([sub_U_train-sub_Um;sub_V_train-sub_Vm]', 'econ');
% rank in QR-pivoting
...
Phi_r = sub_PhiU(1:end/2,1:RModes);
